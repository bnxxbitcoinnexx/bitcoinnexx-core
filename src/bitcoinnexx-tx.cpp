...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinNexx Core bitcoinnexx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinnexx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinnexx transaction") + "\n" +
                               "  bitcoinnexx-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinnexx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinnexx transaction
