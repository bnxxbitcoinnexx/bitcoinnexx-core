...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees,
		bool fProofOfStake, bool fZBNXXStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
	if (!pindexPrev)
		return;
	...
	// } else {
	masternodePayments.FillBlockPayee(txNew, nFees, fProofOfStake, fZBNXXStake);
	// }
}
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew,
		int64_t nFees, bool fProofOfStake, bool fZBNXXStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
