...
/** Utility functions used by the BitcoinNexx Qt UI.
 */
namespace GUIUtil
{
...
// Render BitcoinNexx addresses in monospace font
...
// Parse "bitcoinnexx:" URI into recipient object, return true on successful parsing
