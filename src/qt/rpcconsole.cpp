                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBNXXPathCustom = GetArg("-zbnxxbackuppath", "");
    ...
    if(!strzBNXXPathCustom.empty()) {
        ui->wallet_customzbnxxbackuppath->setText(QString::fromStdString(strzBNXXPathCustom));
        ui->wallet_customzbnxxbackuppath_label->setVisible(true);
        ui->wallet_customzbnxxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBNXXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BitcoinNexx RPC console.") + "<br>" +
