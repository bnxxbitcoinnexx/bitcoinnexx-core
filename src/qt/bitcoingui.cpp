                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinNexx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinNexx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinnexx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBNXX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinNexx Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinNexx Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinNexx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinNexx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinNexx addresses"));
    ...
    openAction->setStatusTip(tr("Open a BitcoinNexx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinNexx Core help message to get a list with possible BitcoinNexx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinNexx Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinNexx network", "", count));
}
...
{
    QString strTitle = tr("BitcoinNexx Core"); // default title
