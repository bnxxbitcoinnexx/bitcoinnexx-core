...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BNXX features */
        {"bitcoinnexx", "masternode", &masternode, true, true, false},
        {"bitcoinnexx", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinnexx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinnexx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinnexx", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinnexx", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinnexx", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinnexx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinnexx", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinnexx", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinnexx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinnexx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinnexx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinnexx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinnexx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinnexx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinnexx", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinnexx", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinnexx", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinnexx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinnexx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinnexx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinnexx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinnexx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinnexx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinnexx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinnexx", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinnexx", "mnsync", &mnsync, true, true, false},
        {"bitcoinnexx", "spork", &spork, true, true, false},
        {"bitcoinnexx", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bitcoinnexx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:54173/\n";
}
