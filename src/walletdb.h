...
public:
    ...
    bool WriteZBNXXSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZBNXXSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZBNXXSeed_deprecated(uint256& seed);
    bool EraseZBNXXSeed();
    bool EraseZBNXXSeed_deprecated();

    bool WriteZBNXXCount(const uint32_t& nCount);
    bool ReadZBNXXCount(uint32_t& nCount);
