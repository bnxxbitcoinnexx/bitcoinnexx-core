...
#else
/**
 * The Secp256k1 curve has an enbitcoinnexxrphism, where lambda * (x, y) = (beta * x, y), where
 ...
 * when decomposing the scalar for an enbitcoinnexxrphism-based point multiplication.
 *
