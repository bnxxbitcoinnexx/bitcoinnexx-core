...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoinnexx-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcoinnexx-cli.cpp \
           src/bitcoinnexx-tx.cpp \
           src/bitcoinnexx.cpp \
           src/db.cpp \
           ...
           src/qt/bitcoinnexx.cpp \
           src/qt/bitcoinnexxstrings.cpp \
...
RESOURCES += src/qt/bitcoinnexx.qrc src/qt/bitcoinnexx_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoinnexx_bg.ts \
                src/qt/locale/bitcoinnexx_de.ts \
                src/qt/locale/bitcoinnexx_en.ts \
                src/qt/locale/bitcoinnexx_es.ts \
                src/qt/locale/bitcoinnexx_fi.ts \
                src/qt/locale/bitcoinnexx_fr.ts \
                src/qt/locale/bitcoinnexx_it.ts \
                src/qt/locale/bitcoinnexx_ja.ts \
                src/qt/locale/bitcoinnexx_pl.ts \
                src/qt/locale/bitcoinnexx_pt.ts \
                src/qt/locale/bitcoinnexx_ru.ts \
                src/qt/locale/bitcoinnexx_sk.ts \
                src/qt/locale/bitcoinnexx_sv.ts \
                src/qt/locale/bitcoinnexx_vi.ts \
                src/qt/locale/bitcoinnexx_zh_CN.ts \
                src/qt/locale/bitcoinnexx_zh_TW.ts
