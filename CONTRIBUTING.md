Contributing to BNXX Core
============================

The BNXX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BNXX Core project, and is not to be
confused with overall BNXX Network Protocol consensus changes.

Whether a pull request is merged into BNXX Core rests with the project merge
...
Patches that change BNXX consensus rules are considerably more involved than
...
Where a patch set proposes to change the BNXX consensus, it must have been
...
The project leader is the release manager for each BNXX Core release.
