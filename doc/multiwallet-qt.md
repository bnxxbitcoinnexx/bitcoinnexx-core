...
In order to support loading of multiple wallets in bitcoinnexx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinnexx.cpp.
...
Changes to bitcoinnexx.cpp
----------------------
bitcoinnexx.cpp is the entry point into bitcoinnexx-qt, and as such, will require some minor modifications to provide hooks for
